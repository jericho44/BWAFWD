    ...
    <section class="section-details-content">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="card card-details card-right mt-sm-3 mt-lg-0">
                        ...
                        <table class="trip-informations">
                            ...
                            <tr>
                                <th width="75%">Total (+Unique Code)</th>
                                <td width="25%" class="text-right text-total">
                    ...
                    <div class="text-center mt-3">
                        <a href="{{ route('detail', $item->travel_package->id) }}" class="text-muted">
                            Cancel Booking
                        </a>
                    </div>
                </div>
